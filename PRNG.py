...
mi_llave = np.array([1.0, 1.0, 1.0], dtype=np.float64)

print(f"Condiciones iniciales: {mi_llave}")
...
texto_cifrado = bits_a_texto(bits_cifrados)

bits_desencriptado = cifrado(bits_cifrados, llave)

print(f"El texto cifrado es: {texto_cifrado}")

texto_desencriptado = bits_a_texto(bits_desencriptado)
